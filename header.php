...
<link href="<?php echo get_template_directory_uri(); ?>/wfd/css/font-awesome.min.css" rel="stylesheet">

	<!-- Loading Drunken Parrot UI -->
<link href="<?php echo get_template_directory_uri(); ?>/wfd/css/drunken-parrot.css" rel="stylesheet">
<link href="<?php echo get_template_directory_uri(); ?>/wfd/css/demo.css" rel="stylesheet">
