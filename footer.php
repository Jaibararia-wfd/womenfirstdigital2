...
<footer id="colophon" class="site-footer clearfix" role="contentinfo">
	...
	<script src="<?php echo get_template_directory_uri(); ?>/wfd/js/bootstrap.min.js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/wfd/js/checkbox.js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/wfd/js/radio.js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/wfd/js/bootstrap-switch.js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/wfd/js/toolbar.js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/wfd/js/application.js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/wfd/js/Chart.min.js"></script>
